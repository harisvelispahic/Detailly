...
export class ServicePackagesApiService {
  ...
  getUploadParams(packageId: number): Observable<CloudinaryUploadParams> {
    return this.http.get<CloudinaryUploadParams>(`${this.baseUrl}/${packageId}/images/upload-params`);
  }

  confirmImage(packageId: number, request: ConfirmImageRequest): Observable<ServicePackageImageDto> {
    return this.http.post<ServicePackageImageDto>(`${this.baseUrl}/${packageId}/images/confirm`, request);
  }
