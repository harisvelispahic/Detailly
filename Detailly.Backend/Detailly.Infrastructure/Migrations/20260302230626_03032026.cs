...
{
    /// <inheritdoc />
    public partial class _03032026 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    BaseDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    BaseRequiredEmployees = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BasePriceMultiplier = table.Column<decimal>(type: "decimal(10,4)", precision: 10, scale: 4, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Addresses_ServiceAddressId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_Locations_ShopLocationId",
                        column: x => x.ShopLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeShifts_ApplicationUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeShifts_Locations_ShopLocationId",
                        column: x => x.ShopLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingEmployeeAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingEmployeeAssignments_ApplicationUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingEmployeeAssignments_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_CartId",
                table: "ApplicationUsers",
                column: "CartId");
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "BookingId", "EmployeeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookingEmployeeAssignments_EmployeeId",
                table: "BookingEmployeeAssignments",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ServiceMode_StartUtc_EndUtc",
                table: "Bookings",
                columns: new[] { "ServiceMode", "StartUtc", "EndUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ShopLocationId_StartUtc_EndUtc",
                table: "Bookings",
                columns: new[] { "ShopLocationId", "StartUtc", "EndUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_Status_ReservationExpiresAtUtc",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeShifts_ShopLocationId_EmployeeWorkMode_StartUtc_EndUtc",
                table: "EmployeeShifts",
                columns: new[] { "ShopLocationId", "EmployeeWorkMode", "StartUtc", "EndUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_ApplicationUserId_TokenHash",
                table: "RefreshTokens",
                columns: new[] { "ApplicationUserId", "TokenHash" },
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApplicationUsers_Carts_CartId",
                table: "ApplicationUsers",
                column: "CartId",
                principalTable: "Carts",
                principalColumn: "Id");
