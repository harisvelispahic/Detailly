...
public sealed class ExportShiftsQueryHandler(IAppDbContext context, IAppCurrentUser currentUser)
    : IRequestHandler<ExportShiftsQuery, List<ExportShiftsQueryDto>>
{
    public async Task<List<ExportShiftsQueryDto>> Handle(ExportShiftsQuery request, CancellationToken ct)
    {
