...
/// </summary>
public sealed class DetaillyBusinessRuleException : Exception
{
    public string Code { get; }

    public DetaillyBusinessRuleException(string code, string message)
        : base(message)
    {
        Code = code;
    }

    public DetaillyBusinessRuleException(string code, string message, Exception? innerException)
